...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
      System.out.println("Your BMI = " + work03.MyUtil.calculateBMI(50, 2.3));
      System.out.println("Average = " + work03.MyUtil.average(4, 5, 6));
   }
   ...
   static void work04UseOfObjectClass() {
       ...
       BankAccount bank1 = new BankAccount(1,A);
       
       Person B = new Person(2);
       BankAccount bank2 = new BankAccount(2,B);
       ...
       System.out.println("Your balance = " + bank1.getBalance());
       
       System.out.println(B.toString());
       System.out.println(bank2.toString());
       System.out.println("Your balance = " + bank2.getBalance());
       /*
